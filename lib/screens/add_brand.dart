...
// import 'package:real_services/Show_Screen/show_brand_data.dart';
...
//   List<BrandModel> driver = [];
//   // var url = Uri.parse('https://apis.pythonanywhere.com/app/brand/');
...
//                   Provider.of<BrandProvider>(context, listen: false).addData({
...
//                 child: Center(child: Text("Add Brand")),
//               ),
//             ),
//           ),
//           SizedBox(height: 10),
...
//               Navigator.push(
//                 context,
//                 MaterialPageRoute(builder: (context) => ShowBrand()),
//               );
//             },
//             child: Container(
//               decoration:
